// function displayValue(e) { // e is the event object
//     // value:
...
// // cell onclick added: event initiates game
// document.querySelector('.game--container').addEventListener('click', handleCellClick);


// function handleCellClick(clickedCellEvent) {
//     if (gameActive) {
//         // referecne to cell click
//         const clickedCell = clickedCellEvent.target;
    
// // grab the index of the cell clicked
// const clickedCellIndex =
// parseInt(clickedCellEvent.target.getAttribute("data-index"));

// // if X or O is already there, ignore the click
// if(gameState[clickedCellIndex] !== "") {
//     return;
// }

// // all good send data to another function; the fucntion for it is not created
...
//         // all three have to have a value
//         if (a=== '' || b === '' || c=== ''){
//             continue; // skip rest but still loops
//         }
//         if (a === b && b === c){
//             gameWon = true;
//             break// finishes loop but continues fucntion
//         }
//     }
// }
